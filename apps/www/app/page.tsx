...
const Page: FC = () => (
  <main className="mx-auto w-full max-w-2xl overflow-hidden px-5 py-10 md:py-12 lg:py-14">
    ...
    <p className="mb-5">
      ...
      <span className="italic">almost</span> every day, life updates sometimes,
      and epic shit-posts most often.
    </p>
    <p className="mb-10">
      See my tweets{" "}
    ...
    <p className="mb-5">
      I open-source most of my recent work. It&apos;s building in public at its
      finest. Besides, it helps me get over the idea that my code is shitty,
      which it always is, to just ship it.
    </p>
    <p>
      See my sources{" "}
